...
This document can serve was a quick crash course on how I go about setting up Git with a remote repository on a notwork drive and not on Github.
...
```
5. Add your remote repository to your local repository
```
